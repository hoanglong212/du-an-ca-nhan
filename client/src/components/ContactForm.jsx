...
function ContactForm({
  ...
  return (
    <div className="surface-card rounded-3xl p-8">
      <h3 className="text-3xl font-bold text-[var(--brand-navy-900)]">{title}</h3>
      ...
      <form className="mt-8 space-y-5" onSubmit={onSubmit}>
        ...
        <button
          className="w-full rounded-2xl bg-[var(--brand-gold-500)] px-6 py-4 text-sm font-bold text-white transition duration-300 hover:scale-[1.01] hover:bg-[var(--brand-gold-600)] disabled:cursor-not-allowed disabled:opacity-60"
          disabled={loading}
          type="submit"
        >
